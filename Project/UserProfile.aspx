                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    <h5 class="card-title fs-1 fw-bold">User Profile</h5>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <asp:Label ID="Label1" runat="server" Text="First Name" CssClass="label"></asp:Label>
                                            <asp:TextBox ID="fname" ClientIDMode="Static" runat="server" CssClass="form-control" placeholder="Enter First Name" ReadOnly="true"></asp:TextBox>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <asp:TextBox ID="email" ClientIDMode="Static" runat="server" CssClass="form-control" placeholder="Enter Email" ReadOnly="true"></asp:TextBox>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <asp:TextBox ID="contact" ClientIDMode="Static" runat="server" CssClass="form-control" placeholder="Enter Contact Number" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <asp:TextBox ID="lname" ClientIDMode="Static" runat="server" CssClass="form-control" placeholder="Enter Last Name" ReadOnly="true"></asp:TextBox>
                                        ...
                                        <div class="form-group mb-4">
                                            <asp:Label ID="Label4" runat="server" Text="Change Password" CssClass="label"></asp:Label>
                                ...
                                <div class="text-center mb-4">
                                    <asp:Button ID="updateUserProfile" ClientIDMode="Static" runat="server" Text="Update" CssClass="btn btn-success w-100 fs-4 py-2 px-5" OnClientClick="return updateUserProfileForm()" />
                                </div>
                            </div>
                        </div>
                    </div>
